...
def ML(Surface):
    ...
    dataset=pd.read_sql_query("Select [Player 1],[Elo Favourite],[Estimated Odds grass] as EstOddsClay,[Estimated Odds] as EstOdds, [Actual Odds] as Odds \
       ...
       where  date like '%' and [Actual Odds] > 1 and [Actual Odds] <1.4 and [Actual Odds] > [Estimated Odds] and [Estimated Odds]>1  and Surface  like '{}'".format(Surface),con=devengine)
    ...
    prediction=pd.read_sql_query("Select [Player 1],[Elo Favourite],[Estimated Odds grass] as EstOddsClay,[Estimated Odds] as EstOdds, [Actual Odds] as Odds \
        ...
        where   [Actual Odds] > 1 and   [Actual Odds] <1.4 and [Actual Odds] > [Estimated Odds] and [Estimated Odds]>1  and Surface  like '{}'".format(Surface),con=devengine)
