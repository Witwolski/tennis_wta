...
data = pd.read_sql_query(
    "Select distinct Surface,Date,Sex,Player_1 as Winner, Player_2 as Loser, Player_1_Odds as Winner_Odds, Player_2_Odds as Loser_Odds FROM AllMatches where Surface = 'Clay' --  >= Convert(datetime, '2021-07-01' )",
    con=devengine,
)
...
data1.to_sql("Elo_AllMatches_Clay", con=devengine, if_exists="replace", index=False)
