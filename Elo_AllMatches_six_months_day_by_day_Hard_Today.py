...
def Elo(date_six_months_ago, date_today, date_today_formatted):
    data = pd.read_sql_query(
        "Select distinct Surface,Date,Sex,Player_1 as Winner, Player_2 as Loser, Player_1_Odds as Winner_Odds, Player_2_Odds as Loser_Odds FROM AllMatches where surface like 'Hard' and tournament not like '%UK Pro%'  and tournament not like '%UTR%' and tournament not like '%Davis%' and date >='{}' and date <= '{}' ".format(
    ...
    data.to_sql(
        "Elo_AllMatches_Daily_Hard_Today",
        con=devengine,
        if_exists="replace",
        index=False,
    )
...
def hard():
    ...
    fav_dog = "fav"
    id = "2yearsfav"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Fav_Odds BETWEEN 1.9 AND 2.1) OR (Elo_Fav_Odds BETWEEN 2.5 AND 2.6))\
        and sex = 'Mens'"
    ...
    fav_dog = "dog"
    id = "2yearsdog"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Dog_Odds BETWEEN 2.7 AND 2.8)  \
        OR (Elo_Dog_Odds BETWEEN 3.6 AND 3.7) OR (Elo_Dog_Odds BETWEEN 1.2 AND 1.4)) and sex = 'Mens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "fav"
    id = "6monthsfav"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Fav_Odds BETWEEN 1.9 AND 2.2) OR (Elo_Fav_Odds BETWEEN 2.9 AND 3)) \
        and sex = 'Mens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "dog"
    id = "6monthsdog"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Dog_Odds BETWEEN 2 AND 2.1) OR (Elo_Dog_Odds BETWEEN 2.7 AND 2.8) \
        OR (Elo_Dog_Odds BETWEEN 3.2 AND 3.3)) and sex = 'Mens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "fav"
    id = "3monthsfav"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Fav_Odds BETWEEN 2 AND 2.1)) \
        and sex = 'Mens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "dog"
    id = "3monthsdog"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Dog_Odds BETWEEN 2.2 AND 2.3) OR (Elo_Dog_Odds BETWEEN 2.7 AND 2.8) OR (Elo_Dog_Odds BETWEEN 1.1 AND 1.2) \
        ) and sex = 'Mens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "fav"
    id = "2yearsfav"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Fav_Odds BETWEEN 2.2 AND 2.3))\
        and sex = 'Womens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "dog"
    id = "2yearsdog"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Dog_Odds BETWEEN 2.1 AND 2.2)  \
        OR (Elo_Dog_Odds BETWEEN 2.5 AND 2.6) OR (Elo_Dog_Odds BETWEEN 2.7 AND 2.9) OR (Elo_Dog_Odds BETWEEN 3 AND 3.1) OR (Elo_Dog_Odds BETWEEN 1.3 AND 1.4)) and sex = 'Womens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "dog"
    id = "6monthsdog"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Dog_Odds BETWEEN 2.8 AND 2.9) OR (Elo_Dog_Odds BETWEEN 3 AND 3.1) OR (Elo_Dog_Odds BETWEEN 1.2 AND 1.3) \
        ) and sex = 'Womens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "fav"
    id = "6monthsfav"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ( (Elo_Fav_Odds BETWEEN 1.1 AND 1.2) \
        ) and sex = 'Womens'"
    get_data(month_year, past, query, fav_dog, id)
    ...
    fav_dog = "dog"
    id = "3monthsdog"
    query = "Select * From Elo_AllMatches_Daily_Hard_Today where ((Elo_Dog_Odds BETWEEN 2.1 AND 2.2) OR (Elo_Dog_Odds BETWEEN 2.5 AND 2.9) OR (Elo_Dog_Odds BETWEEN 1.1 AND 1.3) \
        ) and sex = 'Womens'"
    get_data(month_year, past, query, fav_dog, id)
