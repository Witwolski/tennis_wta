                ...
                if ValidName(player2) == True and ValidName(player1)==True:
                    ...
                    table = [['Date','Sex', 'Tournament', 'Player 1', 'Player 1 Elo', 'Player 2',\
                         'Player 2 Elo','Elo Favourite','Elo Difference','Elo Probability','Estimated Odds',\
                             'Actual Odds', 'Estimated Odds Clay','Estimated Odds Hard','Surface','Elo Difference Clay','Elo Difference Hard','RankDiff'], [datefilename,
                    ...
                    new_df.to_sql("Test_daily",con=devengine,if_exists='append',index=False)

#for x in range(81,90):
for x in range(0,1):
    
    connection.execute('Delete FROM Test_Daily')
    ...
    Filterdf=pd.read_sql_query("Select * From Test_daily",con=devengine)
    ...
    bra4.to_sql("bets_today",con=devengine,index=False,if_exists="append")